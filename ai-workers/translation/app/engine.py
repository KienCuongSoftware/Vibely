...
from .context_boost import prepare_for_mt, restore_proper_nouns
...
class TranslationEngine:
    ...
    def translate(
        ...
        *,
        ...
        prepared, name_map, skip_neural = prepare_for_mt(
            to_translate,
            source_lang=src_iso,
            target_lang=tgt_iso,
        )
        ...
        if skip_neural:
            translated_body = restore_proper_nouns(prepared, name_map)
        else:
            import torch
            ...
            with self._lock:
                ...
                max_in = min(256, max(32, len(prepared) + 16))
                ...
                max_new = min(256, max(24, int(len(prepared.split()) * 3) + 16))
                with torch.no_grad():
            ...
            translated_body = restore_proper_nouns(out.strip() or prepared, name_map)
