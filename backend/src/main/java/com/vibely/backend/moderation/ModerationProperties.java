...
public class ModerationProperties {
    ...
    private int originalitySoftTimeoutMinutes = 5;
    /**
     * Max time a published video may stay HIDDEN waiting for AI clearance before
     * soft-promoting to READY (BLOCK/DELETE decisions still win if present).
     */
    private int publicationHoldTimeoutMinutes = 30;
    /** After this many minutes HIDDEN with CU done, force-enqueue moderation if missing. */
    private int publicationHoldEnqueueAfterMinutes = 3;
