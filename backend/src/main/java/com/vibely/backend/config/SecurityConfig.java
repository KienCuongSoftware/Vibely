    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        HttpSecurity security = http
            ...
            .authorizeHttpRequests(auth -> {
                ...
                .requestMatchers(HttpMethod.HEAD, "/robots.txt", "/sitemap.xml", "/sitemap-*.xml").permitAll()
                ...
                .requestMatchers(HttpMethod.HEAD, "/api/auth/me", "/api/auth/ws-ticket").permitAll()
                ...
                .requestMatchers(HttpMethod.HEAD, "/api/captcha/challenge").permitAll()
                ...
                .requestMatchers(HttpMethod.HEAD, "/api/search/suggest").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/search/users").permitAll()
                .requestMatchers(HttpMethod.HEAD, "/api/search/users").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/search/videos").permitAll()
                .requestMatchers(HttpMethod.HEAD, "/api/search/videos").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/search/semantic").permitAll()
                .requestMatchers(HttpMethod.HEAD, "/api/search/semantic").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/search/hashtags").permitAll()
                .requestMatchers(HttpMethod.HEAD, "/api/search/hashtags").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/search/trending").permitAll()
                .requestMatchers(HttpMethod.HEAD, "/api/search/trending").permitAll()
                ...
                .requestMatchers(HttpMethod.HEAD, "/api/videos/*/comments").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/videos/sound").permitAll()
                .requestMatchers(HttpMethod.HEAD, "/api/videos/sound").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/videos/sounds").permitAll()
                .requestMatchers(HttpMethod.HEAD, "/api/videos/sounds").permitAll()
                ...
                .requestMatchers(HttpMethod.GET, "/api/videos/*/analysis").permitAll()
                .requestMatchers(HttpMethod.HEAD, "/api/videos/*/analysis").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/videos/*/semantic-tags").permitAll()
                .requestMatchers(HttpMethod.HEAD, "/api/videos/*/semantic-tags").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/videos/*/topics").permitAll()
                .requestMatchers(HttpMethod.HEAD, "/api/videos/*/topics").permitAll()
