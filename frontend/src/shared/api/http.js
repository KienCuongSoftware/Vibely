...
const MESSAGE_TO_KEY = {
  ...
  "This email cannot be used": "errors.EMAIL_IN_USE",
  "This email cannot be used (re-verified against the database)": "errors.EMAIL_IN_USE",
  "This email cannot be used. Tap Check again to verify.": "errors.EMAIL_IN_USE",
  "Email may already be in use. Tap Check again to verify.": "errors.EMAIL_IN_USE",
  ...
  "This Vibely ID cannot be used (re-verified against the database)": "errors.USERNAME_TAKEN",
  "This Vibely ID cannot be used. Tap Check again to verify.": "errors.USERNAME_TAKEN",
  "Vibely ID may already exist. Tap Check again to verify.": "errors.USERNAME_TAKEN",
