...
import { ACTIVITY_FILTERS } from '@/features/notification/utils/activityConstants.js'
import { ACTIVITY_PANEL_SHELL_CLASS } from '@/features/notification/utils/activityPanelShell.js'
import { filterActivityItems, groupActivityBySection } from '@/features/notification/utils/activityUtils.js'
import { ActivityNotificationItem } from '@/features/notification/components/ActivityNotificationItem.jsx'
import { ActivitySystemInboxRow } from '@/features/notification/components/ActivitySystemInboxRow.jsx'
          ...
          {ACTIVITY_FILTERS.map((filter) => {
            ...
            return (
              <button
                ...
                className={`vibely-activity-filter-btn cursor-pointer whitespace-nowrap rounded-full px-3 py-1.5 text-xs font-semibold leading-tight transition ${
                  selected
                    ? 'vibely-activity-filter-btn--selected'
                    : fullPage
