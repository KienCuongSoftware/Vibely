import { isValidQualityMode } from '@/features/feed/utils/hlsQualityUtils.js'

/** @typedef {import('@/features/feed/utils/hlsQualityUtils.js').FeedVideoQualityMode} FeedVideoQualityMode */
