...
import { MobileFollowingEmptyState } from "@/features/feed/components/MobileFollowingEmptyState.jsx";
...
import {
  ...
  BookmarkSaveToast,
  NewCollectionModal,
} from "@/features/bookmark/components/BookmarkSaveFeedback";
...
import { FEED_CONFIG } from "@/features/feed/utils/feedConfig.js";
...
import { trimFeedItemsIfNeeded } from "@/features/feed/utils/trimFeedItems.js";
import {
  FEED_NOT_INTERESTED_TOAST_MESSAGE,
  filterNotInterestedVideos,
  markVideoNotInterested,
} from "@/features/feed/utils/feedNotInterestedStorage.js";
import {
...
import { AvatarImage, DEFAULT_AVATAR_URL } from "@/shared/components/AvatarImage.jsx";
import { sanitizeAvatarUrl } from "@/features/profile/utils/avatarUrl.js";
            ...
            <div
              className={
                mobileLayout
                  ...
                  : `relative flex ${FEED_STAGE_OUTER_WIDTH_CLASS} flex-col items-center justify-center overflow-hidden rounded-xl border border-white/10 bg-zinc-950 px-6 text-center sm:rounded-2xl`
              }
            ...
            >
              <div
                className={
                  mobileLayout
                    ? "contents"
                    : // Hug stage height and pin action rail to the bottom (TikTok).
                      // h-full + justify-end was a no-op when the rail collapsed to content height.
                      "vibely-feed-stage-cluster flex shrink-0 items-end"
                }
              >
              <div
                className={
                  mobileLayout
                    ...
                    : feedCommentsOpen && !mobileLayout && feedDockLandscape
                      ? "relative flex min-h-0 w-full flex-col items-start justify-center max-lg:h-full max-lg:flex-1"
                      : feedCommentsOpen && !mobileLayout
                        ? "relative flex min-h-0 w-full flex-col items-center justify-center max-lg:h-full max-lg:flex-1"
                        : "relative max-lg:h-full max-lg:w-full max-lg:flex-1 lg:w-auto lg:shrink-0"
                }
              >
                <FeedPhoneStage
              ...
              <div
                className={
                  mobileLayout
                    ...
                    : `vibely-feed-chrome-rail pointer-events-auto z-30 ml-3 flex shrink-0 flex-col items-center gap-4 pb-6 ${
                        feedCommentsOpen ? "self-center pb-0" : "self-end"
                      }`
                }
              >
                <div
