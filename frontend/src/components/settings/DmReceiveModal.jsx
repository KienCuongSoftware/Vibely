...
export const DM_AUDIENCE_OPTIONS = [
  ...
  { value: 'OFF', label: 'Không nhận' },
]

export function dmAudienceLabel(value) {
  const found = DM_AUDIENCE_OPTIONS.find((item) => item.value === value)
  return found?.label || 'Yêu cầu'
}
  ...
  return (
    ...
    >
      ...
      >
        ...
        <ul className="px-2 py-2" role="radiogroup" aria-label={title}>
